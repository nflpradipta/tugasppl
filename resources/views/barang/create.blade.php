...
@csrf
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name='barang_nama' value="{{ Session::get('barang_nama') }}" id="barang_nama">
            </div>
        </div>
        <div class="mb-3 row">
            <label for="barang_total" class="col-sm-2 col-form-label">Total Barang</label>
            <div class="col-sm-10">
                <input type="number" class="form-control" name='barang_total' value="{{ Session::get('barang_total') }}" id="barang_total">
            </div>
        </div>
        <div class="mb-3 row">
            <label for="barang_kondisi" class="col-sm-2 col-form-label">Kondisi Barang</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name='barang_kondisi' value="{{ Session::get('barang_kondisi') }}"id="barang_kondisi">
            </div>
        </div>
        <div class="mb-3 row">
